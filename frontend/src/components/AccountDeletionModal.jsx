    ...
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-card-bg rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-card-bg border-b border-gray-border p-6 flex justify-between items-center">
          ...
          <button
            onClick={onClose}
            className="hover:bg-[#3A3A45] p-2 rounded-lg"
          >
          ...
          {step === 1 && (
            <>
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-secondary mt-1">
                    All your data, matches, messages, and progress will be
                    permanently deleted.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {reasons.map((reason) => (
                    <label
                      key={reason.id}
                      className="flex items-center gap-3 p-3 hover:bg-[#3A3A45] rounded-lg cursor-pointer"
                    >
                      <input
                        type="checkbox"
              ...
              <p className="text-xs text-text-secondary bg-[#0F0F0F] p-3 rounded-lg">
                Your feedback is valuable and helps us serve our community
                better. This information is confidential and separate from your
                account deletion.
              </p>
            ...
            <>
              <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4">
                ...
                <p className="text-sm text-text-secondary mt-2">
                  You're about to permanently delete your account. Type "DELETE"
                  below to confirm.
                </p>
              </div>
              ...
              <div className="space-y-2 text-sm text-text-secondary bg-[#0F0F0F] p-3 rounded-lg">
                ...
                <ul className="space-y-1 list-disc list-inside">
                  ...
                  <li>
                    Your data will be deleted after 30 days (recovery window)
                  </li>
              ...
              <div className="flex gap-3 pt-4">
                <button
                  onClick={() => setStep(1)}
                  className="flex-1 px-4 py-3 border border-gray-border rounded-lg font-semibold hover:bg-[#3A3A45] transition-colors disabled:opacity-50"
                  disabled={loading}
                >
                  Back
                </button>
