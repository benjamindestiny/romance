...
export default function Dashboard() {
  ...
  // Safe join date calculation (prevents crash for brand-new users)
  ...
  const saveResponse = () => {
    if (userResponse.trim()) {
      ...
      // Safe progress update (never crashes even if progress object doesn't exist yet)
      const updatedUser = {
        ...userData,
        progress: {
          ...(userData?.progress || {}),
  ...
  // Guaranteed default scores – prevents empty comma syntax error
