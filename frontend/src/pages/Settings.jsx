      ...
      <main className="md:ml-64 p-4 md:p-6">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
          <div>
            ...
            <h1 className="text-[#FF69B4] text-2xl font-bold md:hidden">
              Romance
            </h1>
            <p className="text-xl font-bold">Settings</p>
            <p className="text-sm text-gray-400">
              Personalize your Romance experience
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          <aside className="hidden lg:block col-span-1 bg-[#18121F] rounded-2xl p-6 space-y-4">
            <h2 className="text-lg font-semibold text-[#FF69B4] mb-4">
              Categories
            </h2>
            <nav className="space-y-2">
              {activeSectionsLinks.map((item) => (
                <button
                  ...
                  className={`flex items-center space-x-3 w-full text-left rounded-md p-3 ${
                    activeSection === item.id
                      ? "bg-[#FF69B4]/20 text-[#FF69B4] font-medium"
                      : "hover:bg-[#2D2D3A]"
                  }`}
                >
                  {item.icon}
          ...
          <div className="col-span-1 lg:col-span-3 space-y-8">
            ...
            {activeSection === "profile" && (
              <section className="bg-[#18121F] rounded-2xl p-6">
                <h2 className="text-2xl font-semibold text-[#FF69B4] mb-6">
                  Profile Information
                </h2>
                ...
                <form onSubmit={handleSave}>
                  <div className="flex flex-col md:flex-row gap-8 items-start">
                    <div className="relative">
                      ...
                      <label
                        ...
                        className="absolute -bottom-2 -right-2 bg-[#FF69B4] text-white p-3 rounded-full shadow-md cursor-pointer hover:bg-[#E0559B] transition-colors"
                      >
                    ...
                    <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                      {uploading && (
                        <div className="md:col-span-2 bg-[#FF69B4]/10 border border-[#FF69B4]/30 rounded-lg p-3">
                          <p className="text-sm text-[#FF69B4]">
                            Uploading photo...
                          </p>
                        </div>
                      )}
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-[#0F0F14] border border-[#2D2D3A] rounded-lg px-4 py-3"
                        />
                      </div>
                      <div>
                        <label className="block text-sm text-gray-400 mb-1">
                  ...
                  <button
                    type="submit"
                    className="mt-8 bg-[#FF69B4] text-white px-6 py-3 rounded-full text-sm font-medium w-full md:w-auto"
                  >
                    Save Profile
                  </button>
                </form>
              ...
              <section className="bg-[#18121F] rounded-2xl p-6">
                ...
                <div className="space-y-6">
                  <div className="flex justify-between items-center bg-[#0F0F14] border border-[#2D2D3A] rounded-lg p-4">
                    ...
                    <button className="bg-[#FF69B4] text-white px-4 py-2 rounded-md hover:bg-[#E0559B]">
                      Change Password
                    </button>
                  </div>
                  <div className="flex justify-between items-center bg-[#0F0F14] border border-[#2D2D3A] rounded-lg p-4">
            ...
            {activeSection === "privacy" && (
              <section className="bg-[#18121F] rounded-2xl p-6 space-y-6">
                <div>
                  <h2 className="text-2xl font-semibold text-[#FF69B4] mb-2">
                    Privacy & Data
                  </h2>
                  <p className="text-sm text-gray-400">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center p-3 border border-[#2D2D3A] rounded-lg hover:border-[#FF69B4]/50 cursor-pointer transition-colors">
                      <input
                        ...
                        name="visibility"
                        value="public"
                        className="mr-3 accent-[#FF69B4]"
                        defaultChecked
                      />
                      <div>
                        <p className="font-medium">Public</p>
                        <p className="text-sm text-gray-400">
                          Anyone can see your profile and send you messages
                        </p>
                      </div>
                    </label>
                    <label className="flex items-center p-3 border border-[#2D2D3A] rounded-lg hover:border-[#FF69B4]/50 cursor-pointer transition-colors">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          Only people you match with can see your profile
                        </p>
                      </div>
                    </label>
                    <label className="flex items-center p-3 border border-[#2D2D3A] rounded-lg hover:border-[#FF69B4]/50 cursor-pointer transition-colors">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          Your profile is not visible to anyone (you're
                          "invisible")
                        </p>
                      </div>
                    </label>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-3 bg-[#0F0F14] rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          Use your data to improve match suggestions
                        </p>
                      </div>
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                ...
                <div className="border-b border-[#2D2D3A] pb-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="w-full bg-[#0F0F14] border border-[#2D2D3A] rounded-lg px-4 py-3 text-left hover:border-[#FF69B4]/50 transition-colors">
                      ...
                      <p className="text-sm text-gray-400">
                        Get a copy of all your data in a portable format (GDPR)
                      </p>
                    </button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <button className="w-full bg-[#0F0F14] border border-[#2D2D3A] rounded-lg px-4 py-3 text-left hover:border-[#FF69B4]/50 transition-colors">
                    ...
                    <p className="text-sm text-gray-400">
                      Download all your profile information and conversations
                    </p>
                  </button>
                </div>
              </section>
            ...
            {activeSection === "help" && (
              <section className="bg-[#18121F] rounded-2xl p-6 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-gray-400">
                    We're here to help. Find answers or contact our team.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Link
                    to="/reports"
                    className="bg-[#0F0F14] border border-[#2D2D3A] rounded-lg p-4 hover:border-[#FF69B4]/50 transition-colors"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          Report bugs, safety concerns, scams, or inappropriate
                          content
                        </p>
                      </div>
                    </div>
                  ...
                  <a
                    href="mailto:support@romance.app"
                    className="bg-[#0F0F14] border border-[#2D2D3A] rounded-lg p-4 hover:border-[#FF69B4]/50 transition-colors"
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          support@romance.app - Response within 24 hours
                        </p>
                      </div>
                    </div>
                  </a>
                  ...
                  <div className="bg-[#0F0F14] border border-[#2D2D3A] rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          Learn about our safety features and community
                          guidelines
                        </p>
                      </div>
                    </div>
                ...
                <div className="border-t border-[#2D2D3A] pt-6">
                  ...
                  <div className="space-y-3 text-sm">
                    <details className="group">
                      <summary className="cursor-pointer font-medium hover:text-[#FF69B4]">
                        How do I report inappropriate content?
                      </summary>
                      <p className="text-gray-400 mt-2 ml-4">
                        Go to Reports page or use the report option on any
                        profile or message. Our team reviews all reports within
                        24 hours.
                      </p>
                    </details>
                    <details className="group">
                      ...
                      <p className="text-gray-400 mt-2 ml-4">
                        Please contact our safety team immediately at
                        safety@romance.app. If you're in immediate danger,
                    ...
                    <details className="group">
                      ...
                      <p className="text-gray-400 mt-2 ml-4">
                        ...
                        to start the account deletion process. Your feedback
                ...
                <div className="border-t border-[#2D2D3A] pt-6">
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    ...
                    completely removed after 30 days.
                  </p>
                </div>
              </section>
            )}
