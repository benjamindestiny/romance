...
export default function Reports() {
  ...
  const [reportHistory, setReportHistory] = useState([
    {
      ...
      date: "Jan 14, 2026",
      status: "Resolved",
      excerpt: "Inappropriate messages received",
    },
    {
      id: 2,
      name: "James Wilson",
      type: "Scam/Fraud Report",
      date: "Jan 20, 2026",
      status: "Under Review",
      excerpt: "Suspicious payment request",
    },
  ]);
  ...
  const reportTypes = [
    ...
    {
      id: "scam",
      label: "Scam/Fraud Report",
      icon: <ExclamationTriangleIcon className="size-5" />,
    },
    {
      id: "bug",
      label: "Report a Bug",
      icon: <BugAntIcon className="size-5" />,
    },
    {
      id: "inappropriate",
    ...
    <div className="min-h-screen bg-dark-bg text-text-primary font-sans pb-32 md:pb-0">
      ...
      <main className="md:ml-64 p-4 max-w-7xl mx-auto">
        <header className="mb-8">
          <h1 className="text-primary-purple text-3xl font-bold md:hidden mb-2">
            Romance
          </h1>
          ...
          <p className="text-text-secondary mt-2 max-w-2xl">
            Help us keep Romance safe and enjoyable for everyone. Provide clear
            details and our team will follow up quickly.
          </p>
        </header>
            ...
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-text-secondary mt-2">
                  We've received your report and our moderation team will review
                  it.
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-3 p-4 rounded-lg border transition-all text-left ${
                          reportType === type.id
                            ...
                            : "border-gray-border hover:border-primary-purple/40"
                        }`}
                      >
                        {type.icon}
                        <div>
                ...
                <div className="bg-[#0F0F0F] rounded-lg p-4 border border-gray-border text-xs text-text-secondary">
                  <p>
                    <strong>Privacy:</strong> Your report is confidential and
                    will only be shared with our moderation team. We never
                    disclose the identity of report submitters unless required
                    by law.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-3 border border-gray-border rounded-lg font-semibold hover:bg-card-bg"
                  >
                    Clear
                  </button>
                </div>
          ...
          <aside className="md:col-span-1 space-y-4">
            <div className="bg-card-bg rounded-2xl p-4 shadow-sm">
                ...
                {reportHistory.map((r) => (
                  <li key={r.id} className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div
                        className={`mt-2 inline-flex items-center text-xs font-semibold px-2 py-1 rounded ${r.status === "Resolved" ? "bg-green-500/10 text-green-400" : r.status === "Under Review" ? "bg-yellow-500/10 text-yellow-400" : "bg-primary-purple/10 text-primary-purple"}`}
                      >
                        {r.status}
                      </div>
                    </div>
              ...
              <div className="mt-4 text-xs text-text-secondary">
                <div className="flex items-center gap-2">
                  <ClockIcon className="size-4" /> Please allow up to 48 hours
            ...
            <div className="bg-card-bg rounded-2xl p-4 shadow-sm border border-primary-purple/10">
              ...
              <p className="text-xs text-text-secondary">
                If you or someone is in immediate danger, please contact local
                emergency services first. For urgent platform support, email{" "}
                <Link to="mailto:support@romance.app">support@romance.app</Link>
                .
              </p>
            </div>
          </aside>
