    ...
    try {
      await axios.post(
        `${import.meta.env.VITE_API_URL}/api/quiz/submit`,
        {
          ...
          score: Math.round(percentage / 10), // maps nicely to existing scoring (max ~10 points per category)
        },
        ...
        {view === "results" && (
          <div className="max-w-2xl mx-auto text-center bg-card-bg rounded-3xl p-10">
            ...
            <div className="text-text-secondary mb-10">
              Great work, Nova! This growth will make your future couple quizzes
