      ...
      <main className="md:ml-64 p-4">
        ...
        <header className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-xl font-bold">{greeting}, {userName}</p>
        ...
        {/* Stat Cards – FIXED: icons now text-white to match pink bg perfectly */}
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <QuickActionCard to="/counseling" icon={<UserCircleIcon className="size-6 text-primary-purple" />} title="Book Counseling" description="Connect with a licensed therapist for your relationship." />
            <QuickActionCard to="/community" icon={<UsersIcon className="size-6 text-primary-purple" />} title="Join Community" description="Connect with others on similar journeys and share experiences." />
            <QuickActionCard to="/reports" icon={<ExclamationTriangleIcon className="size-6 text-primary-purple" />} title="Report an Issue" description="Help us keep our community safe and trustworthy." />
          </div>
        </section>
        ...
        <section className="md:flex md:space-x-6 mb-8">
          <div className="md:w-[75%]">
            ...
            <div className="bg-card-bg p-6 rounded-2xl">
              ...
              {responseSaved && (
                <p className="text-green-400 text-sm mt-3">Saved! +5 to your health score today.</p>
              )}
            </div>
          </div>
          ...
          <div className="md:w-1/2 mt-8 md:mt-0">
            ...
            <div className="bg-card-bg p-4 rounded-lg space-y-4">
              <div>
                <div className="flex justify-between text-sm"><p>Communication Skills</p><p>0%</p></div>
              ...
              <div>
                <div className="flex justify-between text-sm"><p>Emotional Intelligence</p><p>0%</p></div>
                <div className="bg-progress-bg h-2 rounded-full cursor-pointer hover:opacity-80 transition-opacity">
                  <div className="bg-primary-purple h-2 rounded-full w-[0%] hover:bg-pink-accent transition-colors"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm"><p>Conflict Resolution</p><p>0%</p></div>
                <div className="bg-progress-bg h-2 rounded-full cursor-pointer hover:opacity-80 transition-opacity">
                  <div className="bg-primary-purple h-2 rounded-full w-[0%] hover:bg-pink-accent transition-colors"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm"><p>Self-Awareness</p><p>0%</p></div>
                <div className="bg-progress-bg h-2 rounded-full cursor-pointer hover:opacity-80 transition-opacity">
                  <div className="bg-primary-purple h-2 rounded-full w-[0%] hover:bg-pink-accent transition-colors"></div>
                </div>
              </div>
